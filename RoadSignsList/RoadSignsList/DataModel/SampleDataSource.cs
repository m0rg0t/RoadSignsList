...
namespace RoadSignsList.Data
{
    ...
    public abstract class SampleDataCommon : RoadSignsList.Common.BindableBase
    {
        ...
        public async void LoadSignsData()
        {
            ...
            try
            {
                ...
                foreach (var item in o["result"])
                {
                    ...
                    var sign_count = 1;
                    foreach (var sign in item["objects"])
                    {
                        try
                        {
                            ...
                            if (sign_count == 1)
                            {
                                group1.SetImage(sign["signs_src"].ToString());
                            };
